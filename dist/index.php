        ...
        -->
          ...
          <div class="mt-5 h-0 flex-1 overflow-y-auto">
            <nav class="space-y-1 px-2">
              ...
              <a href="index.php" class="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                <!--
      ...
      <div class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-[#FEF9EF] pt-5">
        ...
        <div class="mt-5 flex flex-grow flex-col">
          <nav class="flex-1 space-y-1 px-2 pb-4">
            <!-- Current: "bg-gray-100 text-gray-900", Default: "text-gray-600 hover:bg-gray-50 hover:text-gray-900" -->
            <a href="index.php" class="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
              <!--
              Heroicon name: outline/home
                  ...
                  <div class="p-5">
                    <div class="flex items-center">
                      ...
                      <div class="ml-5 w-0 flex-1">
                        <dl>
                          <dt class="truncate text-sm font-medium text-gray-500">Openstaande bestellingen</dt>
                          <dd>
