...
<div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="w-full max-w-md space-y-8">
    <div>
      ...
      <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Maak een nieuw account aan</h2>
    ...
    <form class="mt-8 space-y-6" action="#" method="POST">
      ...
      <div class="flex items-center justify-between">
        <div class="text-sm">
        <a href="login.php" class="font-medium text-[#e32e34] hover:text-[#FFA733]">Login</a>
        </div>

        <div class="text-sm">
          <a href="resetpassword.php" class="font-medium text-[#e32e34] hover:text-[#FFA733]">Wachtwoord vergeten?</a>
        </div>
      </div>
